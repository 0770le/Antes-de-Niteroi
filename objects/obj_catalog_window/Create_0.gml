...
function create_content()
{
	...
	var _last_item = catalog_tabs[CATALOG_TAB.REGIONS].add_item(instance_create_layer(bbox_left + 30, bbox_top + 40, LAYER_GUI_CATALOG_BUTTONS, obj_catalog_item));
	...
	_last_item = catalog_tabs[CATALOG_TAB.HISTORY].add_item(instance_create_layer(bbox_left + 30, bbox_top + 40, LAYER_GUI_CATALOG_BUTTONS, obj_catalog_item));
	...
	_last_item = catalog_tabs[CATALOG_TAB.BIODIVERSITY].add_item(instance_create_layer(bbox_left + 30, bbox_top + 40, LAYER_GUI_CATALOG_BUTTONS, obj_catalog_item));
