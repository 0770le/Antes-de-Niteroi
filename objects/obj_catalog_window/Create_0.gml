...
#region //// biodiversity items
	...
	_last_item.set_text("A onça-pintada(Panthera onca) é capaz de abater presas maiores que ela emprega diversas técnicas de caça com emboscadas silenciosas, perseguições rápidas e natação. Sua pelagem oferece excelente camuflagem na vegetação densa .\nSua mordida é a mais potente de todos os felinos em relação ao tamanho, capaz de perfurar cascos de tartarugas e couro de jacarés com facilidade. Essa força permite que a onça mate suas presas com uma única mordida, frequentemente direcionada para partir o crânio ou pescoço.\n Há registros de onças pesando até 160kg, com 2,5 metros do comprimento(excluindo cauda) e quase 1m de altura do chão até o topo de seu dorso (excluindo pescoço e cabeça)./nAs onças dominavam a baía de guanabara e não era raro que uma pessoa fosse devorada por uma. Os tupinambás presenteavam seus recém nascidos com suas presas.");	
	_last_item.image = spr_catalog_empty;
